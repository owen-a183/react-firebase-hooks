...
const BookIO = () => {
    ...
    const editBook = (tutorial, index) => {
        const { title, description, bookCode, complete, entryDate, entryTotal } = tutorial.val();
        setCurrentTutorial(null)
        setCurrentTutorial({
            key: tutorial.key,
            title,
                            ...
                            <table class="min-w-max w-full table-auto">
                                <thead>
                                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                                        <th class="py-3 px-6 text-left">Book Code - Title</th>
                                        <th class="py-3 px-6 text-left">Entry Date</th>
                                        <th class="py-3 px-6 text-left">Entry Total</th>
                                            ...
                                            >
                                                ...
                                                <td class="py-3 px-6 text-left">
                                                    <div class="flex items-center">
                                                        <span class="font-medium">{tutorial.val().bookCode + ' - ' + tutorial.val().title}</span>
                                                    </div>
                                                </td>
                                                <td class="py-3 px-6 text-left">
                                                    <div class="flex items-center">
                                                        <span class="font-medium">{tutorial.val().entryDate}</span>
                                                    </div>
                                                </td>
                                                <td class="py-3 px-6 text-left">
                                                    <div class="flex items-center">
                                                        <span class="font-medium">{tutorial.val().entryTotal}</span>
                                                    </div>
                                                </td>
                                                <td class="py-3 px-6 text-left">
                                                    <div class="flex items-center">
                                                ...
                                                {tutorial.val().complete ? (
                                                    <td class="py-3 px-6 text-center">
                                                        <span class="bg-green-200 text-green-600 py-1 px-3 rounded-full text-xs">Complete</span>
                                                    </td>) : (
                                                    <td class="py-3 px-6 text-center">
                                                        <span class="bg-red-200 text-red-600 py-1 px-3 rounded-full text-xs">Incomplete</span>
                                                    </td>)}
                                                <td class="py-3 px-6 text-center">
